    ...
    WCP.ColorPicker.prototype.refreshWidget = function () {
        ...
        for (var i in options.sliders) {
            ...
            switch (this.options.sliders[i]) {
                case 'w':
                    $slider = $widget.find('.jQWCP-wWheel');
                    break;
                case 'h':
                    $slider = $widget.find('.jQWCP-wHue');
                    break;
                case 's':
                    $slider = $widget.find('.jQWCP-wSat');
                    break;
                case 'v':
                    $slider = $widget.find('.jQWCP-wVal');
                    break;
                case 'r':
                    $slider = $widget.find('.jQWCP-wRed');
                    break;
                case 'g':
                    $slider = $widget.find('.jQWCP-wGreen');
                    break;
                case 'b':
                    $slider = $widget.find('.jQWCP-wBlue');
                    break;
                case 'a':
                    $slider = $widget.find('.jQWCP-wAlpha');
                    break;
                case 'p':
                    $slider = $widget.find('.jQWCP-wPreview');
                    break;
            }
        ...
        if (options.autoResize && !mobileLayout) {
            ...
            if ($visSliders.length > 0) {
                ...
                $visSliders.css({
                    ...
                    width: (horzSpace - ($visSliders.length - 1) * sliderMargins) / $visSliders.length + 'px'
                });
            }
        }
